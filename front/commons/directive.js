...
define(['app', 'ztree-core', 'Service'], function (app) {
    ...
    /*使输入的数字自动加上千位符*/
        ...
        // 决策通知书流程提交弹出框
        .directive('decisionBpmnPopWin', function () {
            return {
                restrict: 'AE',
                templateUrl: BUSINESS_PATH + 'directive/common/decisionBpmnPopWin.html',
                replace:'true',
                scope:{approve:'='},
        ...
        .directive('bpmnPopWin', function (Window, CommonService) {
            return {
                ...
                controller: function ($scope, $location, $http) {
                    ...
                    $scope.submitNext = function () {
                        console.log($("input[name='bpmnProcessOption']:checked").val());

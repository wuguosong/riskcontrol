define(['app', 'Service'], function (app) {
    app
        .register.controller('noticeDecisionDraftInfoCtrl', ['$http', '$scope', '$location', '$stateParams', 'BEWG_URL', 'Window', 'CommonService',
        function ($http, $scope, $location, $stateParams, BEWG_URL, Window, CommonService) {
            console.log('noticeDecisionDraftInfo');
            ...
            $scope.showSubmitModal = function(){
                ...
                Window.confirm('注意', "提交后将不可修改，确定提交？").result.then(function (btn) {
                    /*show_Mask();*/
                    $http({
                        method:'post',
                        url: SRV_URL + $scope.localUrl,
            ...
            $scope.getProjectFormalReviewByID=function(id){
                ...
                $http({
                    ...
                    if(action == "Create"){
                        ...
                        $http({
                            method:'post',
                            url: SRV_URL + 'noticeDecisionDraftInfo/queryNoticeDecstion.do',
            ...
            $scope.cancel = function (){
                $location.path("/index/NoticeDecisionDraftList/0");
            }

define(['app', 'Service', 'select2'], function (app) {
    app
        .register.controller('preBiddingInfoViewCtrl', ['$http', '$scope', '$location', '$stateParams', 'BEWG_URL', 'Window',
        function ($http, $scope, $location, $stateParams, BEWG_URL, Window, Upload) {
            console.log('preBiddingInfoView');
            ...
            $scope.cancel = function (){
                $location.path("/index/PreBiddingInfoList/1");
            };
        }]);
});
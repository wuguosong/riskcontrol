define(['app', 'Service', 'select2'], function (app) {
    app
        .register.controller('tecTransformReportCtrl', ['$http', '$scope', '$location', '$stateParams', 'BEWG_URL', 'Window',
        function ($http, $scope, $location, $stateParams, BEWG_URL, Window, Upload) {
            console.log('tecTransformReport');
            ...
            $scope.saveReport2 = function(callBack){
                if(typeof callBack == 'function') {
                    ...
                    if (typeof ($scope.formalReport._id) != "undefined") {
                        ...
                        url_post = BEWG_URL.BEWG_URL.SaveReportPfr;
                    }
                    $http({
                        method:'post',
                        url: url_post,
            ...
            $scope.cancel = function (){
                $location.path("/index/FormalReportList_new/0");
            };

...
class Bookmark { 
    ...
    public XWPFParagraph getContainerParagraph() {
    	return this._para;
    }
    
    /**
     * @return the table contain this bookmark
     */
    ...
    /**
     * @return the tableRow contain this bookmark
     */
    ...
    public int getRowNum(){
    	if(this.isInTable()){
    		XWPFTable table = getContainerTable();
    		XWPFTableRow row = getContainerTableRow();
    		int rowNum = 0;
    ...
    /*The method has some problem*/
//    public void insertBodyElementAtBookMark(IBodyElement body, int where) { 
//        
//        //���ݱ�ǩ�����ͣ����в�ͬ�Ĳ���
//        if(this._isCell) { 
//            this.handleBookmarkedCells(bookmarkValue, where); 

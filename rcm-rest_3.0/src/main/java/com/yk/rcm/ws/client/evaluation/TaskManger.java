    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.yk.rcm.ws.client.evaluation.TaskManger.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.yk.rcm.ws.client.evaluation.TaskManger.class.getResource(".");
            url = new URL(baseUrl, "http://10.10.20.86:8899/HeTaskMangerWeb/services/TaskManger?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://10.10.20.86:8899/HeTaskMangerWeb/services/TaskManger?wsdl', retrying as a local file");

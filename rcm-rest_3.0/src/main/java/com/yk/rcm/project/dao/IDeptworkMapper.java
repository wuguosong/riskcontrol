...
public interface IDeptworkMapper extends BaseMapper {
	...
	public Map<String, Object> getProjectLast(@Param("processKey") String processKey,
			@Param("businessId") String businessId, @Param("TEAM_MEMBER_ID") String TEAM_MEMBER_ID,
			@Param("MESSAGE_SCREEN_TYPE") String MESSAGE_SCREEN_TYPE);

	public Map<String, Object> getNowLegalStaffWork(Map<String, Object> nowStaffWorkQuery);

	public List<Map<String, Object>> getOneLegalStaffWork(Map<String, Object> nowStaffWorkQuery);

	public Map<String, Object> getProjectLegalLast(@Param("processKey") String processKey,
			@Param("businessId") String businessId, @Param("TEAM_MEMBER_ID") String TEAM_MEMBER_ID,
			@Param("MESSAGE_SCREEN_TYPE") String MESSAGE_SCREEN_TYPE);

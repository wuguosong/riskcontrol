 ...
 * @author hubiao
 */
public class PreTzLogFilter implements IProjectTzFilter {
	private static final Logger log = LoggerFactory.getLogger(PreTzLogFilter.class);
	@Resource
	...
	public void doFilter(Map<String, Object> data, Result result,
		...
		try {
			...
			wsCallService.saveWsServer("TZPRE", content, resultText, result.isSuccess());
		} catch (Exception e) {

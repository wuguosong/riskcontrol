...
@WebServiceClient(name = "BEWG_Message_Service",
        wsdlLocation = "http://10.10.2.85:8080/message/service?wsdl",
        targetNamespace = "http://tempuri.org/")
public class BEWGMessageServicePrd extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://10.10.2.85:8080/message/service?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(BEWGMessageService.class.getName())
                    .log(java.util.logging.Level.INFO,
                            "Can not initialize the default wsdl from {0}", "http://10.10.2.85:8080/message/service?wsdl");
        }
        WSDL_LOCATION = url;
    }

    public BEWGMessageServicePrd(URL wsdlLocation) {
        super(wsdlLocation, SERVICE);
    }

    public BEWGMessageServicePrd(URL wsdlLocation, QName serviceName) {
        super(wsdlLocation, serviceName);
    }

    public BEWGMessageServicePrd() {
        super(WSDL_LOCATION, SERVICE);
    }

    public BEWGMessageServicePrd(WebServiceFeature ... features) {
        super(WSDL_LOCATION, SERVICE, features);
    }

    public BEWGMessageServicePrd(URL wsdlLocation, WebServiceFeature ... features) {
        super(wsdlLocation, SERVICE, features);
    }

    public BEWGMessageServicePrd(URL wsdlLocation, QName serviceName, WebServiceFeature ... features) {

...
public class MessageClient {
	...
	String _URL = prop.get("message.share.url") + prop.get("message.request.mapping");
	String _CONTENT = prop.get("message.share.content");
	String _TITLE = prop.get("message.share.title");

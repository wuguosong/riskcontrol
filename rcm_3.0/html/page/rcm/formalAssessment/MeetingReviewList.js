...
ctmApp.register.controller('FormalReviewListToday', ['$http','$scope','$location', function ($http,$scope,$location) {
    //查义所有的操作
    $scope.ListAll=function(){
        $scope.httpData('projectPreReview/Meeting/getPolicyDecisionTodayAll').success(
            function (data, status, headers, config) {

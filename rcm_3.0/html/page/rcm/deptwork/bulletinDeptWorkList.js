ctmApp.register.controller('bulletinDeptWorkList', ['$routeParams','$http','$scope','$location', function ($routeParams,$http,$scope,$location) {
	...
	if($scope.serviceTypeId != null && $scope.serviceTypeId !="" && $scope.serviceTypeId !="\"\""){
		...
		$http({
		    ...
		    params:{"uuid":$scope.serviceTypeId}
	...
	$scope.getForamlAssessmentList = function(){
		...
		$http({
			method:'post',  
		    url: srvUrl + "bulletinInfo/queryListByPage.do",

 ...
 function ($http,$scope,$location,$routeParams) {
	...
	$scope.save = function(){
		if($("#myFormPPR").valid()) {
			...
			show_Mask();
			$scope.pfr.formalId = objId;
			var  url = 'information/addConferenceInformation.do';
			...
			$http({
				 ...
				 $location.path("ConferenceInformationDetailView/"+objId+"/"+oldUrl);
	 		});
		}
	}

ctmApp.register.controller('FormalBiddingInfoPreviewOld', ['$http','$scope','$location','$routeParams','Upload','$filter',
    function ($http,$scope,$location,$routeParams,Upload,$filter) {
       ...
       /* //处理附件列表
        ...
        $scope.previewJson = function () {
            ...
            $scope.formalPreview.projectType = $scope.formalReport.policyDecision.projectType
            $scope.formalPreview.investmentAmount = $scope.formalReport.policyDecision.investmentAmount
            $scope.formalPreview.projectSize = $scope.formalReport.policyDecision.projectSize
            $scope.formalPreview.rateOfReturn = $scope.formalReport.policyDecision.rateOfReturn
            $scope.formalPreview.fkPsResult = $scope.formalReport.fkPsResult
            $scope.formalPreview.fkRiskTip = $scope.formalReport.fkRiskTip
            $scope.formalPreview.specialNotice = $scope.formalReport.policyDecision.specialNotice

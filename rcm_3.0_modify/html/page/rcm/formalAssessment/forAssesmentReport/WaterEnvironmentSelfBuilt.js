    ...
    function ($http,$scope,$location,$routeParams,Upload) {
        ...
        $scope.initData = function(){
            if(action=="Create"){
                ...
                $scope.formalReport.governmentProcurement = 0;
                $scope.formalReport.projectProcedure = 0;
                $scope.formalReport.projectWarehouse = 0;
                $scope.formalReport.signSubject = 0;
                $scope.formalReport.whetherConstructionIsCompleted = 0;
                $scope.formalReport.whetherWeNeedToBuild = 0;
                $scope.formalReport.isContainsConstruction = 0;
                $scope.formalReport.whetherToObtainLoanTermSheet = 0;
                $scope.formalReport.whetherNeedAddLetter = 0;
                $scope.formalReport.wetherCommissioningCharge = 0;
                $("#wordbtn").hide();
        ...
        $scope.addtableRow=function(n){
            ...
            if(n==1){
                ...
                addcellRow($scope.formalReport.projectConcernsIssues.leadershipDecision,'projectConcernsIssues');
            }else if(n==2){
                if(undefined==$scope.formalReport.projectConcernsIssues){
                ...
                addcellRow($scope.formalReport.projectConcernsIssues.investmentConditions,'projectConcernsIssues');
            }else if(n==3){
                if(undefined==$scope.formalReport.projectConcernsIssues){
                ...
                addcellRow($scope.formalReport.projectConcernsIssues.prompt,'projectConcernsIssues');
            }else if(n==5){
                if(undefined==$scope.formalReport.projectConcernsIssues){
                    $scope.formalReport.projectConcernsIssues={fundUsetableOneConditions:[]};
                }
                if(undefined==$scope.formalReport.projectConcernsIssues.fundUsetableOneConditions){
                    $scope.formalReport.projectConcernsIssues.fundUsetableOneConditions=[];
                }
                addcellRow($scope.formalReport.projectConcernsIssues.fundUsetableOneConditions,'fundUsetable');
            }else if(n==6){
                if(undefined==$scope.formalReport.projectConcernsIssues){
                    $scope.formalReport.projectConcernsIssues={fundUsetableTwoConditions:[]};
                }
                if(undefined==$scope.formalReport.projectConcernsIssues.fundUsetableTwoConditions){
                    $scope.formalReport.projectConcernsIssues.fundUsetableTwoConditions=[];
                }
                addcellRow($scope.formalReport.projectConcernsIssues.fundUsetableTwoConditions,'fundUsetable');
            }else if(n==7){
                if(undefined==$scope.formalReport.projectConcernsIssues){
                    $scope.formalReport.projectConcernsIssues={profitContributionTableConditions:[]};
                }
                if(undefined==$scope.formalReport.projectConcernsIssues.profitContributionTableConditions){
                    $scope.formalReport.projectConcernsIssues.fundUsetableTwoConditions=[];
                }
                addcellRow($scope.formalReport.projectConcernsIssues.profitContributionTableConditions,'profitContributionTable');
            }
        ...
        $scope.delrow=function(name,num){
            if(num==1) {
                ...
                var names = $scope.formalReport.projectConcernsIssues.fundUsetableOneConditions;
                names.splice(name, 1);
                if (names.length > 0) {
                    $scope.formalReport.projectConcernsIssues.fundUsetableOneConditions = names;
                } else {
                    $scope.formalReport.projectConcernsIssues.fundUsetableOneConditions = [];
                }
            }else if(num==6) {
                var names = $scope.formalReport.projectConcernsIssues.fundUsetableTwoConditions;
                names.splice(name, 1);
                if (names.length > 0) {
                    $scope.formalReport.projectConcernsIssues.fundUsetableTwoConditions = names;
                } else {
                    $scope.formalReport.projectConcernsIssues.fundUsetableTwoConditions = [];
                }
            }else if(num==7) {

ctmApp.register.controller('FormalEnvirProjectList', ['$routeParams','$http','$scope','$location', function ($routeParams,$http,$scope,$location) {
    ...
    $scope.createProject=function(){
        $location.path("/formalEnvirProjectInfo/0/1");
    };

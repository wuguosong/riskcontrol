...
ctmApp.register.controller('bulletinProjectBoardList', ['$routeParams','$http','$scope','$location', '$filter', function ($routeParams,$http,$scope,$location,$filter) {
    ...
    $scope.getProjectList1 = function(){
        ...
        $scope.paginationConf1.queryObj.stageList = ['1', '1.5'];
    ...
    $scope.getProjectList3 = function(){
        ...
        $scope.paginationConf3.queryObj.stageList = ['4','5','9'];
    ...
    $scope.getProjectList4 = function(){
        if($scope.paginationConf4.queryObj == null || $scope.paginationConf4.queryObj == ''){
            $scope.paginationConf4.queryObj = {};
        }

        if ($scope.projectName != null && $scope.projectName != ''){
            var projectName = $filter('decodeURI')($scope.projectName,"VALUE");
            $scope.paginationConf4.queryObj.projectName = projectName;
        }

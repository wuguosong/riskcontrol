ctmApp.register.controller('MeetingSubmit', ['$http', '$scope', '$location', '$routeParams', '$filter', function ($http, $scope, $location, $routeParams, $filter) {
    ...
    $scope.changeMeetingTime = function () {
        console.log($scope.meetingIssue.MEETING_TIME);
    ...
    $scope.changeIsDate = function () {
        console.log($scope.meetingIssue);
        console.log($scope.meetingIssue.MEETING_TIME);
        $scope.meetingIssue.MEETING_TIME = null;
        $scope.meetingIssue.MEETING_ISSUE_NUMBER = null;
        $scope.meetingIssue.MEETING_ISSUE = null;
        $scope.meetingIssue.START_TIME = null;
        $scope.meetingIssue.END_TIME = null;
        $scope.meetingIssue.MEETING_LEADERS = [];
        $scope.meetingInfo = null;

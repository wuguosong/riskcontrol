    ...
    $scope.getProjectList1 = function () {
        ...
        if (!isEmpty($scope.params)) {
            ...
            if ($scope.credentials.userName == '于良法' || $scope.credentials.userName == '崔杰' || $scope.credentials.userName == '牟洪礼') {
                $scope.paginationConf1.queryObj.pertainareaName = '东部';
            } else if ($scope.credentials.userName == '杨光' || $scope.credentials.userName == '徐秀群' || $scope.credentials.userName == '魏山钧') {
                $scope.paginationConf1.queryObj.pertainareaName = '中部';
            } else if ($scope.credentials.userName == '简畅' || $scope.credentials.userName == '陈奇林') {
    ...
    $scope.getProjectList2 = function () {
        ...
        if (!isEmpty($scope.params)) {
            ...
            if ($scope.credentials.userName == '于良法' || $scope.credentials.userName == '崔杰' || $scope.credentials.userName == '牟洪礼') {
                ...
                $scope.paginationConf2.queryObj.pertainareaName = '中部';
            } else if ($scope.credentials.userName == '简畅' || $scope.credentials.userName == '陈奇林') {
    ...
    $scope.getProjectList3 = function () {
        ...
        if (!isEmpty($scope.params)) {
            ...
            if ($scope.credentials.userName == '于良法' || $scope.credentials.userName == '崔杰' || $scope.credentials.userName == '牟洪礼') {
                ...
                $scope.paginationConf3.queryObj.pertainareaName = '中部';
            } else if ($scope.credentials.userName == '简畅' || $scope.credentials.userName == '陈奇林') {
    ...
    $scope.getProjectList4 = function () {
        ...
        if (!isEmpty($scope.params)) {
            ...
            if ($scope.credentials.userName == '于良法' || $scope.credentials.userName == '崔杰' || $scope.credentials.userName == '牟洪礼') {
                ...
                $scope.paginationConf4.queryObj.pertainareaName = '中部';
            } else if ($scope.credentials.userName == '简畅' || $scope.credentials.userName == '陈奇林') {
    ...
    $scope.getProjectList5 = function () {
        ...
        if (!isEmpty($scope.params)) {
            ...
            if ($scope.credentials.userName == '于良法' || $scope.credentials.userName == '崔杰' || $scope.credentials.userName == '牟洪礼') {
                ...
                $scope.paginationConf5.queryObj.pertainareaName = '中部';
            } else if ($scope.credentials.userName == '简畅' || $scope.credentials.userName == '陈奇林') {

...
ctmApp.controller('SysControl', ['$scope', '$cookies', '$http', '$location', '$interval', '$rootScope', '$filter', 'DirPipeSrv', '$window',
    function ($scope, $cookies, $http, $location, $interval, $rootScope, $filter, DirPipeSrv, $window) {
        ////到cookie中读取用户名及密码
        //服务端地址信息
        $scope.srvInfo = {
            srvUrl: srvUrl

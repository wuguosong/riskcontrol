ctmApp.register.controller('preReportBoardList', ['$routeParams','$http','$scope','$location', function ($routeParams,$http,$scope,$location) {
	...
	$scope.getCounts = function(){
		$http({
			method:'post',  
		    url: srvUrl + "preReportBoard/getCounts.do",
	...
	$scope.getEndList = function(){
		$http({
			method:'post',  
			url: srvUrl + "preReportBoard/queryPreReportBoardList.do",

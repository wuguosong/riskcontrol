...
@WebServiceClient(name = "UpToDoServiceImplService",
                  wsdlLocation = "http://10.10.232.3:8081/ws/upToDo?wsdl",
...
public class UpToDoServiceImplServicePrd extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://10.10.232.3:8081/ws/upToDo?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UpToDoServiceImplServicePrd.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "http://10.10.232.3:8081/ws/upToDo?wsdl");
        }
        WSDL_LOCATION = url;
    }

...
public class Constants {
	 ...
	 */
//	10100 光伏的code码
	public static final String SYS_ORG_CODE_ROOT = "10100";
	/**
	 * 东部战区code
	 */
	...
	/**
	 * 消息借口-短信类型 必填参数： content:短信内容 target:短信接收人手机号
	 */
	public static final String MESSAGE_TYPE_SMS = "SMS";
	/**
	 * 消息借口-钉钉链接类型 必填参数： touser或toparty必填一个 messageUrl:链接消息指向的URL picUrl:链接消息显示的图标
	 * text:链接消息显示的文本 title:链接消息显示的标题
	 */
	public static final String MESSAGE_TYPE_DT_LINK = "DT_LINK";
	/**
	 * 消息借口-钉钉文本类型 必填参数： touser或toparty必填一个 content:文本消息内容
	 */
	public static final String MESSAGE_TYPE_DT_TEXT = "DT_TEXT";
	/**
	 * 消息借口-微信文本类型 必填参数： touser或toparty必填一个 content:文本消息内容
	 */
	public static final String MESSAGE_TYPE_WX_TEXT = "WX_TEXT";
	/**
	 * 消息借口-邮箱类型 必填参数： sender:发送方Email target:接收方Email title:邮件标题 content:消息内容
	 * 
	 */
	public static final String MESSAGE_TYPE_EMAIL = "EMAIL";

	/**
	 * author: Sam Gao date: 2018-12-05 风控评审意见汇总 必填参数： _id:意见汇总id type:项目类型
	 * status:意见状态 content:内容
	 * 
	 */
	public static final String RCM_FORMAL_SUMMARY = "rcm_formal_summary";

	/**
	 * author: Sunny Qi date: 2019-06-12 历史数据Mongo表 必填参数： _id:历史数据id-业务id
	 * 
	 */

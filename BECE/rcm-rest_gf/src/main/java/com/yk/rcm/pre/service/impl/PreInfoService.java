...
public class PreInfoService implements IPreInfoService {
	...
	public void saveTaskPerson(String json) {
		...
		if (Util.isNotEmpty(legalReviewLeader)) {
			params.put("businessId", businessId);
			params.put("legalReviewPersonId", (String) legalReviewLeader.get("VALUE"));
			this.updatePersonById(params);
		}
		/* end保存法律评审人相关信息 Add by LiPan 2019-05-24 */
...
//            Map<String, Object> dataForOracle = packageDataForOracle(doc);
		...
		map.put("URL", prefix + "/html/index.html#/preInfo/" + businessid + "/2");
		map.put("URL_PRO", prefix + "/html/index.html#/projectPreInfoAllBoardView/" + businessid + "/"
	...
	@SuppressWarnings("unchecked")
	private Map<String, Object> packageDataForOracle_V01(Map<String, Object> doc) {
...
//		}
		params.put("serviceType", apply.getString("KEY"));
		...
		params.put("stage", doc.get("stage"));
	...
	@Override
	public List<Map<String, Object>> queryPreCount(String wf_state, String stage, String pertainAreaId,
			String serviceTypeId, String year) {
		Map<String, Object> map = new HashMap<String, Object>();

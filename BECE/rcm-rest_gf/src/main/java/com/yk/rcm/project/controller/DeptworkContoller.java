...
public class DeptworkContoller {
	...
	public Result queryFormalCount(HttpServletRequest request){
		...
		List<Map<String, Object>> list = this.formalAssessmentInfoService.queryFormalCount(wf_state,stage,noticeResult,pertainAreaId,serviceTypeId,year);
		Map<String, Object> map = new HashMap<String,Object>();
		map.put("list", list);
		if(Util.isEmpty(year)){
			int y = Util.now().getYear()+1900;
	...
	public Result queryNoticeCount(HttpServletRequest request){
		...
		List<Map<String, Object>> list = this.deptworkService.queryNoticedCount(resultt,pertainAreaId,serviceTypeId,year);
		Map<String, Object> map = new HashMap<String,Object>();
		map.put("list", list);
		if(Util.isEmpty(year)){
			int y = Util.now().getYear()+1900;
	...
	public Result queryPreCount(HttpServletRequest request){
		...
		List<Map<String, Object>> list = this.preInfoService.queryPreCount(wf_state,stage,pertainAreaId,serviceTypeId,year);
		Map<String, Object> map = new HashMap<String,Object>();
		map.put("list", list);
		if(Util.isEmpty(year)){
			int y = Util.now().getYear()+1900;
	...
	public Result getFromWghByServietypeWithGm(){
		Result result = new Result();
		Map<String,Object> resultData = new HashMap<String,Object>();
		List<Map<String, Integer>> formalaWghReportsByServiceWithGm = deptworkService.getFormalaWghReportsByServiceWithGm();
	...
	public Result getFromWghByServietypeAndAreaWithNum(){
		Result result = new Result();
		Map<String,Object> resultData = new HashMap<String,Object>();
		List<Map<String,Object>> fromWghByServietypeAndAreaWithNum = deptworkService.getFromWghByServietypeAndAreaWithNum();
	...
	public Result getPreFromWghByServietypeAndAreaWithNum(){
		Result result = new Result();
		Map<String,Object> resultData = new HashMap<String,Object>();
		List<Map<String,Object>> fromWghByServietypeAndAreaWithNum = deptworkService.getPreFromWghByServietypeAndAreaWithNum();
		List<String> areaList = new ArrayList<String>();
		List<String> serviceTypeList = new ArrayList<String>();
		Map<String, Map<String, Object>> items = new TreeMap<String, Map<String, Object>>();
		for (Map<String, Object> map : fromWghByServietypeAndAreaWithNum) {
	...
	public Result getFromWghByServietypeAndAreaWithGm(){
		Result result = new Result();
		Map<String,Object> resultData = new HashMap<String,Object>();
		List<Map<String,Object>> getFromWghByServietypeAndAreaWithGm = deptworkService.getFromWghByServietypeAndAreaWithGm();
		List<String> areaList = new ArrayList<String>();
		List<String> serviceTypeList = new ArrayList<String>();
		Map<String, Map<String, Object>> items = new TreeMap<String, Map<String, Object>>();
	...
	public Result getPreFromWghByServietypeAndAreaWithGm(){
		Result result = new Result();
		Map<String,Object> resultData = new HashMap<String,Object>();
		List<Map<String,Object>> getFromWghByServietypeAndAreaWithGm = deptworkService.getPreFromWghByServietypeAndAreaWithGm();
		List<String> areaList = new ArrayList<String>();
		List<String> serviceTypeList = new ArrayList<String>();
		Map<String, Map<String, Object>> items = new TreeMap<String, Map<String, Object>>();
		for (Map<String, Object> map : getFromWghByServietypeAndAreaWithGm) {
	...
	public Result getFromYghByServietypeAndAreaWithNum(){
		Result result = new Result();
		Map<String,Object> resultData = new HashMap<String,Object>();
		List<Map<String,Object>> getFromYghByServietypeAndAreaWithNum = deptworkService.getFromYghByServietypeAndAreaWithNum();
		List<String> areaList = new ArrayList<String>();
		List<String> serviceTypeList = new ArrayList<String>();
		Map<String, Map<String, Object>> items = new TreeMap<String, Map<String, Object>>();
	...
	public Result getPreFromYghByServietypeAndAreaWithNum(){
		Result result = new Result();
		Map<String,Object> resultData = new HashMap<String,Object>();
		List<Map<String,Object>> getFromYghByServietypeAndAreaWithNum = deptworkService.getPreFromYghByServietypeAndAreaWithNum();
		List<String> areaList = new ArrayList<String>();
		List<String> serviceTypeList = new ArrayList<String>();
		Map<String, Map<String, Object>> items = new TreeMap<String, Map<String, Object>>();
		for (Map<String, Object> map : getFromYghByServietypeAndAreaWithNum) {
	...
	public Result getFromYghByServietypeAndAreaWithGm(){
		Result result = new Result();
		Map<String,Object> resultData = new HashMap<String,Object>();
		List<Map<String,Object>> getFromYghByServietypeAndAreaWithGm = deptworkService.getFromYghByServietypeAndAreaWithGm();
		List<String> areaList = new ArrayList<String>();
		List<String> serviceTypeList = new ArrayList<String>();
		Map<String, Map<String, Object>> items = new TreeMap<String, Map<String, Object>>();
	...
	public Result getPreFromYghByServietypeAndAreaWithGm(){
		Result result = new Result();
		Map<String,Object> resultData = new HashMap<String,Object>();
		List<Map<String,Object>> getFromYghByServietypeAndAreaWithGm = deptworkService.getPreFromYghByServietypeAndAreaWithGm();
		List<String> areaList = new ArrayList<String>();
		List<String> serviceTypeList = new ArrayList<String>();
		Map<String, Map<String, Object>> items = new TreeMap<String, Map<String, Object>>();
		for (Map<String, Object> map : getFromYghByServietypeAndAreaWithGm) {
	...
	public Result initTablePreYghByServietypeAndAreaWithNum(){
		Result result = new Result();
		Map<String,Object> resultData = new HashMap<String,Object>();
		List<Map<String,Object>> fromWghByServietypeAndAreaWithNum = deptworkService.getPreFromYghByServietypeAndAreaWithNum();
		List<String> areaList = new ArrayList<String>();
		List<String> serviceTypeList = new ArrayList<String>();
	...
	public Result initTableFormalYghByServietypeAndAreaWithNum(){
		Result result = new Result();
		Map<String,Object> resultData = new HashMap<String,Object>();
		List<Map<String,Object>> fromWghByServietypeAndAreaWithNum = deptworkService.getFromYghByServietypeAndAreaWithNum();
		List<String> areaList = new ArrayList<String>();
		List<String> serviceTypeList = new ArrayList<String>();
		List<Map<String,Object>> serviceTypeMapList = new ArrayList<Map<String,Object>>();
	...
	public Result queryBulletinCount(HttpServletRequest request){
		...
		List<Map<String, Object>> list = bulletinInfoService.queryBulletinCount(wf_state,stage,pertainAreaId,serviceTypeId,year);
		Map<String, Object> map = new HashMap<String,Object>();
		map.put("list", list);
		if(Util.isEmpty(year)){
			int y = Util.now().getYear()+1900;
	...
	public Result initTableBulletinWghByServietypeAndAreaWithNum(){
		Result result = new Result();
		Map<String,Object> resultData = new HashMap<String,Object>();
		List<Map<String,Object>> fromWghByServietypeAndAreaWithNum = deptworkService.getBulletinFromWghByServietypeAndAreaWithNum();
		List<String> areaList = new ArrayList<String>();
		List<String> serviceTypeList = new ArrayList<String>();
		List<Map<String,Object>> serviceTypeMapList = new ArrayList<Map<String,Object>>();
	...
	public Result initTableBulletinYghByServietypeAndAreaWithNum(){
		Result result = new Result();
		Map<String,Object> resultData = new HashMap<String,Object>();
		List<Map<String,Object>> fromWghByServietypeAndAreaWithNum = deptworkService.getBulletinFromYghByServietypeAndAreaWithNum();
		List<String> areaList = new ArrayList<String>();
		List<String> serviceTypeList = new ArrayList<String>();
		List<Map<String,Object>> serviceTypeMapList = new ArrayList<Map<String,Object>>();
	...
	public Result getBulletinFromYghByServietypeAndAreaWithNum(){
		Result result = new Result();
		Map<String,Object> resultData = new HashMap<String,Object>();
		List<Map<String,Object>> getFromYghByServietypeAndAreaWithNum = deptworkService.getBulletinFromYghByServietypeAndAreaWithNum();
		List<String> areaList = new ArrayList<String>();
		List<String> serviceTypeList = new ArrayList<String>();
		Map<String, Map<String, Object>> items = new TreeMap<String, Map<String, Object>>();
		for (Map<String, Object> map : getFromYghByServietypeAndAreaWithNum) {
